    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException {
        ...
        if(pass.equalsIgnoreCase(cpass)){
            RequestBody formBody = new FormEncodingBuilder()
                ...
                .add("password", pass)
                .build();
            r = getString("crearUsuario", formBody);
     ...
     public String getString(String metodo, RequestBody formBody) {
        ...
        try {
            ...
            Response resp = webClient2.newCall(req).execute();//Aqui obtiene la respuesta en dado caso si hayas pues un return en python
