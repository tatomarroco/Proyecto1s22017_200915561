...
/* +++++++++LA SIGUIENTE LINEA DE CODIGO ES como en FLASK (app.route donde ponen el path que tomará la petición para una funcion)++++++++*/
@WebServlet(urlPatterns = {"/conectServer"})
/*---------------------------------------------------------------------------------------------------------------------------------------*/
public class conectServer extends HttpServlet{
